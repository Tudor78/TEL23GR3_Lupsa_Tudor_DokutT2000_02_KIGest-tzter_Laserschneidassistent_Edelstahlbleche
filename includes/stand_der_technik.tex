...
\begin{figure}[!htbp]
    ...
    \caption{Beispiele zur Plausibilitätsprüfung durch \enquote{Iron-hunter}: links eine gültige Aufnahme der Schnittkante, rechts eine Fehlaufnahme mit sichtbaren Fingern, die verworfen wird.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.49\linewidth]{keyence _koord.jpg}\hfill
